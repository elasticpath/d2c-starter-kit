...
export const config = {
  ...
  stripeKey:
    process.env.REACT_APP_STRIPE_KEY || "pk_test_JwRX4cevuCysIEQrpwcbn3j8",
  categoryPageSize: 8,
  maxCompareProducts: 4,
  algoliaAppId: process.env.REACT_APP_ALGOLIA_APP_ID || "6MAFUOD23U",
  algoliaApiKey:
    process.env.REACT_APP_ALGOLIA_API_KEY || "7d829396bbf202b30bfe7ad52120bbac",
  algoliaPlacesAppId:
    process.env.REACT_APP_ALGOLIA_PLACES_APP_ID || "plEPUZAA2D2L",
  algoliaPlacesApiKey:
    process.env.REACT_APP_ALGOLIA_PLACES_API_KEY ||
    "4c9f0832a65f800e31b0d50f44670b1f",
