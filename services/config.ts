...
export const config = {
  clientId: process.env.REACT_APP_CLIENT_ID || 'Y18tXJb49HYxeJPLKBYdOJcVgM9OiWbN7PuORDhGpS',
  clientSecret: process.env.REACT_APP_CLIENT_SECRET || "r1k3OUsycDiWL8QKYJ7rdCqb3SaRt5Y205FKaigaUN",
