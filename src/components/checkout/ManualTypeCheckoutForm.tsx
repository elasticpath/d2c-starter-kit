...
import { captureOrder, makePayment } from "../../services/checkout";
...
const manualPaymentRequest: PaymentRequestBody = {
  gateway: "manual",
  method: "authorize",
};

export default function ManualTypeCheckoutForm({
  checkout,
  showCompletedOrder,
  ...
  const steps = [
    ...
    { name: "Billing Information", isActive: false },
  ];
